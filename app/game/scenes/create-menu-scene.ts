...
import { createMenuCamera } from '@game/camera/create-menu-camera';
import { MenuAtmosphereSystem } from '@game/systems/menu-atmosphere.system';
import { createMenuWorld } from '@game/world/create-menu-world';
